...
const {
    ...
    getMyAssignments, getMyLocationHistory, assignRescueTeam, trackMyRescueTeam, updateAssignedSOSStatus,
...
router.get("/my/location-history", authorize("RescueTeam"), getMyLocationHistory);

...
const createShelter = async (req, res) => {
    try {
        ...
        const shelter = await Shelter.create(setDistrictOnCreate(req, req.body));
...
const getAllShelters = async (req, res) => {
    try {
        ...
        const shelters = await Shelter.find(scopedFilter(req)).sort({ createdAt: -1 });
...
const getShelterById = async (req, res) => {
    try {
        ...
        const shelter = await Shelter.findOne({ _id: req.params.id, ...scopedFilter(req) });

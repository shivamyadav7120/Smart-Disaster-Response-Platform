...
const getNearbyHospitals = async(req,res)=>{
    ...
    try{
        ...
        const hospitals = await Hospital.find({ ...scopedFilter(req), isActive:true
...
const getNearbyShelters = async(req,res)=>{
    ...
    try{
        ...
        const shelters = await Shelter.find({ ...scopedFilter(req), isActive:true

...
export default function LiveMap({
  ...
  const loadData = async () => {
    ...
    try {
      ...
      setBlockedRoads(Array.isArray(blockedData) ? blockedData : [])
      ...
      >
        ...
        >
          ...
          {visible.risk && (
            ...
            <GeoJSON
              data={{ type: "FeatureCollection", features: riskZones.map(z => ({ type: "Feature", geometry: z.geometry, properties: { name: z.name, risk: z.risk, score: z.score } })) }}
              style={riskStyle}
            ...
            blockedRoads.map(
              (b) => (
                ...
                <CircleMarker
                  ...
                  center={[
                    Number(b.latitude ?? b.lat),
                    Number(b.longitude ?? b.lng),
                  ]}

...
export function AuthProvider({ children }) {
  ...
  const login = async (email, password) => {
    ...
    if (loggedUser.role === "DistrictAdmin" && loggedUser.district) {
      localStorage.setItem("sdrp_admin_district", loggedUser.district);
    } else if (loggedUser.role !== "SuperAdmin") {
      localStorage.removeItem("sdrp_admin_district");
    }
    setUser(loggedUser);
